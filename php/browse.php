...
<div class="infobox">
	...
	if ($files != false > 0){
		for ($i = $mode; $i < $page_max_img && $i < count($files); $i++) {
			...
			echo '<a class="file-item" href="' . $location[0] . '" target="_blank">[view]</a>';
			echo '</div>';
		}
	}
