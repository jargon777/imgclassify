...
switch ($mode) {
	case ("http"):
		echo '
			...
			<span class="item-action">Archives bigger than 100MiB not reccomended. Dropbox links can be process automatically if you paste the shareable link. For other services, please ensure you get a direct link to the file. If you paste the link in your browser, it should ask to "download" that file.</span>
